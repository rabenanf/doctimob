...
export const FamilyMemberScreen = ({ navigation }: Props): JSX.Element => {
  ...
  const { createMember, updateMember, deleteMember, getMembersByPatient } =
    FamilyMemberService();
  ...
  const validate = () => {
    ...
    if (!firstname.trim())
      newErrors.firstname = t("FamilyMember.errorFirstname");
            ...
            <View style={styles.addContainer}>
              ...
              <View style={styles.action}>
                <RoundedButton
                  isPrimary={true}
                  onButtonPress={() => {
                    if (update) updateFamilyMember();
                    else createFamilyMember();
                  }}
